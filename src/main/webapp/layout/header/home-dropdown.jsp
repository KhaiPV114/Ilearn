                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="12-marketplace.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h12.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                                        href="12-marketplace.html">Marketplace
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="04-kindergarten.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h4.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                                        href="04-kindergarten.html">kindergarten
                                        <span class="btn-icon"><i
                                                class="feather-arrow-right"></i></span></a>
                                </h4>
                            </div>
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="13-university-classic.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h13.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="14-home-elegant.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h14.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                                        href="14-home-elegant.html">Home Elegant
                                        <span class="btn-icon"><i
                                                class="feather-arrow-right"></i></span></a>
                                </h4>
                            </div>
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="09-gym-coaching.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h9.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                                        href="09-gym-coaching.html">Gym Coaching
                                        <span class="btn-icon"><i
                                                class="feather-arrow-right"></i></span></a>
                                </h4>
                            </div>
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="03-online-school.html"
                                   class="active"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h3.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                                        href="03-online-school.html"
                                        class="active">Online School <span
                                            class="btn-icon"><i
                                                class="feather-arrow-right"></i></span></a>
                                </h4>
                            </div>
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="06-university-status.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h6.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="15-home-technology.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h15.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="07-instructor-portfolio.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h7.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="08-language-academy.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h8.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="11-single-course.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h11.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="10-online-course.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h10.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="05-classic-lms.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h5.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                                        href="05-classic-lms.html">Classic Lms
                                        <span class="btn-icon"><i
                                                class="feather-arrow-right"></i></span></a>
                                </h4>
                            </div>
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="02-course-school.html"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/h2.jpg"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                                <h4 class="title"><a
                ...
                <div
                    ...
                    <div class="demo-single">
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="#"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/coming-soon-1.png"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                ...
                <div
                    ...
                    <div class="demo-single">
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="#"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/coming-soon-2.png"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
                ...
                <div
                    ...
                    <div class="demo-single">
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="#"><img
                                        src="${pageContext.request.contextPath}/assets/images/splash/demo/coming-soon-3.png"
                                        alt="Demo Images"></a>
                            </div>
                            <div class="content">
